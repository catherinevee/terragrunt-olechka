...
inputs = {
  bucket = "olechka-prod-app-data-2024"
  ...
  # Enhanced lifecycle rules for production environment
  lifecycle_rule = [
    {
      id      = "transition-to-ia"
      enabled = true
  ...
  # Enhanced bucket policies for production
  attach_policy = true
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      ...
      },
      {
        ...
        Principal = "*"
        Action = "s3:PutObject"
        Resource = "arn:aws:s3:::olechka-prod-app-data-2024/*"
        Condition = {
          StringNotEquals = {
