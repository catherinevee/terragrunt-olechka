...
inputs = {
  role_name = "olechka-dev-application-role"
  role_description = "Enhanced IAM role for development application servers"
    ...
    application_policy = jsonencode({
      ...
      Statement = [
        ...
        },
        {
          ...
          Resource = [
            "arn:aws:logs:eu-west-2:*:log-group:/aws/ec2/olechka-dev/*",
            "arn:aws:logs:eu-west-2:*:log-group:/aws/rds/olechka-dev/*"
          ]
        },
        {
          Effect = "Allow"
  ...
  permissions_boundary = "arn:aws:iam::123456789012:policy/olechka-dev-permissions-boundary"
