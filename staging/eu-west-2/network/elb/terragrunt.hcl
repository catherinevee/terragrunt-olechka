...
inputs = {
  ...
  access_logs = {
    bucket = "olechka-staging-logs-2024"
    prefix = "alb-logs"
  }
  ...
  load_balancer_attributes = [
    ...
    },
    {
      ...
      value = "true"  # Protect from deletion in staging
    },
    {
    ...
    },
    {
      ...
      value = "olechka-staging-logs-2024"
    },
    {
