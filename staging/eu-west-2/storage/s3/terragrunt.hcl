...
inputs = {
  bucket = "olechka-staging-app-data-2024"

  # Enhanced access control for staging
  ...
  # Enhanced lifecycle rules for staging environment
  lifecycle_rule = [
    {
      id      = "transition-to-ia"
      enabled = true
  ...
  # Enhanced bucket policies for staging
  attach_policy = true
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      ...
      },
      {
        ...
        Principal = "*"
        Action = "s3:PutObject"
        Resource = "arn:aws:s3:::olechka-staging-app-data-2024/*"
        Condition = {
          StringNotEquals = {
