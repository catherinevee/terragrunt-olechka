...
inputs = {
  name = "olechka-staging-waf"
  description = "Enhanced WAF for staging environment"
  ...
  visibility_config = {
    ...
    metric_name                = "olechka-staging-waf-metric"
    sampled_requests_enabled   = true
  }

  # Enhanced rules for staging environment
  rules = [
    {
    ...
    },
    {
      ...
      statement = {
        geo_match_statement = {
          country_codes = ["CN", "RU", "KP", "IR"]  # Block specific countries in staging
        }
      }
